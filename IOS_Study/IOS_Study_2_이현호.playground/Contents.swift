...
func == (student1: Student, student2: Student) -> Bool{
    if((student1.classNum - student2.classNum) == 0){
        return true
    }else{
        return false
    }
...
var temp: Array<String> = ["a", "b", "d", "D", "E", "F"]
alphabetArr2 = temp
